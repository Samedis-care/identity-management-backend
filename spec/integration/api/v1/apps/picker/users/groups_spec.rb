...
#     rails g auto_swagger_spec v1_app_picker_user_groups
...
describe 'Actors::Groups API', swagger_doc: 'v1/swagger.json', "actors::groups" => true  do
  ...
  path '/api/v1/apps/{app_id}/picker/users/{user_id}/groups' do
...
parameter name: "user_id", in: :path,
  ...
  path '/api/v1/apps/{app_id}/picker/users/{user_id}/groups/{id}' do
