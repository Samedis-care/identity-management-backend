...
#     rails g auto_swagger_spec v1_app_tenant_user_roles
...
describe 'Roles API', swagger_doc: 'v1/swagger.json', "roles" => true  do
  ...
  path '/api/v1/apps/{app_id}/tenants/{tenant_id}/users/{user_id}/roles' do
...
parameter name: "user_id", in: :path,
  ...
  path '/api/v1/apps/{app_id}/tenants/{tenant_id}/users/{user_id}/roles/{id}' do
