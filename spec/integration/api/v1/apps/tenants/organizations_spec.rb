...
#     rails g auto_swagger_spec v1_app_tenant_organizations
...
describe 'Actors API', swagger_doc: 'v1/swagger.json', "actors" => true  do
  ...
  path '/api/v1/apps/{app_id}/tenants/{tenant_id}/organizations' do
...
parameter name: "id", in: :path,
      ...
      parameter name: :data, in: :body,
                schema: serializer::Schema.new.rswag_schema(
                  base_key: :data,
                  only: [:name, :short_name, :full_name, :actor_type, :parent_id, :title_translations],
                  #required: []
                )
  ...
  path '/api/v1/apps/{app_id}/tenants/{tenant_id}/organizations/{id}' do
...
parameter name: "id", in: :path,
      ...
      parameter name: :data, in: :body,
                schema: serializer::Schema.new.rswag_schema(
                  base_key: :data,
                  only: [:name, :short_name, :full_name, :title_translations],
                  required: []
                )
