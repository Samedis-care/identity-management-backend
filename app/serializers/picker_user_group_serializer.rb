class PickerUserGroupSerializer
  ...
  attribute :already_assigned_to_user do |record, params|
    (params[:group_ids_assigned_to_user]||[]).collect(&:to_s).include?(record.id.to_s)
  end
