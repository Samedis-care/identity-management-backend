class ActorSerializer
  ...
  has_many :children, record_type: :actor, serializer: :actor do |actor|
    # only used for structure user actors need not be editable directly
    # (would be too much data without pagination anyhow)
    actor.children.tree_nodes
  end
  has_many :roles, record_type: :role, serializer: :role_overview
